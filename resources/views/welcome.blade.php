...
.nav-menu a.active::after{
    ...
    /* Tentang Kami */
    .about { background-color: var(--text-light); padding: 80px 0; overflow: hidden; }

.about-layout {
  display: flex; align-items: center; justify-content: space-between;
  gap: 60px; max-width: 1140px; margin: 0 auto; padding: 0 20px; flex-wrap: wrap;
}

.about-text {
  flex: 1.2; min-width: 300px; font-size: 1.1rem; 
  line-height: 1.9; color: #444; text-align: justify;
}

.about-text h2 { 
  font-size: 2rem; color: var(--primary-red); margin-bottom: 20px; 
}
...
.about-img-box { 
    flex: 1; 
    min-width: 300px; 
    position: relative; /* Penting untuk menumpuk gambar */
    height: 300px;      /* Sesuaikan dengan tinggi fotomu */
}
...
.tagline-wrapper {
  ...
  width: 100%;
  margin: 30px 0; /* Memberi jarak dengan elemen lain */
}
...
.tagline-container {
  background: #ffffff;
  padding: 15px 40px;
  border-radius: 50px; /* Lengkungan halus */
  border: 1px solid #eee; /* Garis tipis supaya lebih elegan */
  box-shadow: 0 4px 10px rgba(0,0,0,0.05); /* Bayangan lembut */
  font-size: 18px;
  color: #555;
  text-align: center;
  width: fit-content; /* Ukuran menyesuaikan teks */
}
...
.tagline-container .highlight {
  ...
  text-transform: uppercase;
    ...
    text-align: center;
    font-size: 2rem;
    color: #444; /* Abu-abu tua yang lebih lembut dari hitam */
    letter-spacing: 2px; /* Memberi kesan modern dan lega */
    text-transform: uppercase; /* Membuat judul terlihat lebih tegas/kokoh */
    margin-bottom: 30px;
    font-weight: 300; /* Font yang lebih tipis memberi kesan elegan */
}
...
.partners-section {
    ...
    width: 100%;
    margin: 60px 0;
    /* Membuat sudut lengkung yang halus di atas dan bawah */
...
.mitra-card {
    ...
    padding: 20px;
    flex-shrink: 0;
    overflow: hidden;       /* Biar gambar ga keluar dari border-radius */
}

/* Penting: Styling untuk gambarnya */
.mitra-card img {
    width: 80px;            /* Sesuaikan ukuran gambar */
    height: 80px;           /* Sesuaikan ukuran gambar */
    object-fit: contain;    /* Biar gambar tidak terdistorsi/gepeng */
    margin-bottom: 10px;
}

/* Image Styling */
.mitra-card .slide img {
    width: 100px;
    height: 100px;
    object-fit: contain;
    margin-bottom: 15px;
  ...
  <div class="about-layout">
    ...
    <div class="about-img-box">
      <div class="slider-container">
        ...
        <div class="slide"><img src="/assets/poto.png" alt="Es Brasil 3" /></div>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="partners-slider">
    <div class="partners-track">
      <div class="mitra-card">
        <div class="slide"><img src="/assets/logo1.png" alt="Mitra 1" /></div>
        <p>LuLu</p>
      </div>
      <div class="mitra-card">
        <div class="slide"><img src="/assets/logo2.png" alt="Mitra 2" /></div>
        <p>Mang Engking</p>
      </div>
      <div class="mitra-card">
        <div class="slide"><img src="/assets/poto.png" alt="Mitra 3" /></div>
        <p>NAGA Swalayan</p>
      </div>
      <div class="mitra-card">
        <div class="slide"><img src="/assets/logo1.png" alt="Mitra 4" /></div>
        <p>Sindang Reret</p>
      </div>
      <div class="mitra-card">
        <div class="slide"><img src="/assets/logo2.png" alt="Mitra 5" /></div>
        <p>Sop Janda</p>
      </div>
...
<section id="lowongan" class="job-vacancy-section">
    ...
    <div class="job-vacancy-container">
        ...
        <div class="job-vacancy-graphic">
            <img
                src="{{ asset('assets/gambar1.png') }}"
                alt="Ilustrasi Lowongan"
                class="peeking-character">
        </div>
